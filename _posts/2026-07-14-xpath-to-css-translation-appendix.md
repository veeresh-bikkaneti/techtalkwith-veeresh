...
A pocket reference that pairs the XPath you've already written with the CSS (or Playwright engine selector) that fits the modern stack. Pre-requisite reading: the [XPath Cheatsheet §11 Advanced and complex patterns]({{ site.baseurl }}{% link _posts/2026-07-13-xpath-cheatsheet-for-test-automation.md %}#11-advanced-complex-patterns-svg-shadow-dom-modern-css). Every row below cross-references an existing row in §§3–11 of the cheatsheet or §§1–12 of the [article]({{ site.baseurl }}{% link _posts/2026-07-12-xpath-for-test-automation.md %}).
...
**Scenario-to-cheatsheet cross-reference.** Each scenario exercises a specific slice of the cheatsheet — so a search hit on any §-anchor in the [cheatsheet]({{ site.baseurl }}{% link _posts/2026-07-13-xpath-cheatsheet-for-test-automation.md %}) can jump back to the worked example that demonstrates it in context:

| Scenario | Cheatsheet §-refs crossed |
|---|---|
| **Scenario 1 — Login form** (`A2 + E1 + F1`) | [§5 Predicate recipes]({{ site.baseurl }}{% link _posts/2026-07-13-xpath-cheatsheet-for-test-automation.md %}#5-predicate-recipes) (text-match + `and`/`not`); [§10.1 POM placement]({{ site.baseurl }}{% link _posts/2026-07-13-xpath-cheatsheet-for-test-automation.md %}#10-sdet-playbook-pom-waits-ci-observability) (locator-as-property); [§11.6 State pseudos]({{ site.baseurl }}{% link _posts/2026-07-13-xpath-cheatsheet-for-test-automation.md %}#11-advanced-complex-patterns-svg-shadow-dom-modern-css) (`:not([disabled])`) |
| **Scenario 2 — Dynamic striped table** (`A4 + B3 + D8 + F5`) | [§4 10 functions]({{ site.baseurl }}{% link _posts/2026-07-13-xpath-cheatsheet-for-test-automation.md %}#4-10-functions-youll-actually-use) (`starts-with`, `contains`, `translate()`); [§5 Predicate recipes]({{ site.baseurl }}{% link _posts/2026-07-13-xpath-cheatsheet-for-test-automation.md %}#5-predicate-recipes) (position); [§11.5 :nth-child formulas]({{ site.baseurl }}{% link _posts/2026-07-13-xpath-cheatsheet-for-test-automation.md %}#11-advanced-complex-patterns-svg-shadow-dom-modern-css); [§11.6 Case-insensitive flag]({{ site.baseurl }}{% link _posts/2026-07-13-xpath-cheatsheet-for-test-automation.md %}#11-advanced-complex-patterns-svg-shadow-dom-modern-css) (`[attr*='x' i]`) |
| **Scenario 3 — Reverse-tree ARIA + shadow DOM** (`C1 + C2 + X3`) | [§3 The 13 axes]({{ site.baseurl }}{% link _posts/2026-07-13-xpath-cheatsheet-for-test-automation.md %}#3-the-13-axes) (ancestor axis); [§11.3 iframe + shadow DOM]({{ site.baseurl }}{% link _posts/2026-07-13-xpath-cheatsheet-for-test-automation.md %}#11-advanced-complex-patterns-svg-shadow-dom-modern-css) (`>>>` piercing); [§11.4 Modern CSS `:has()`/`:is()`/`:where()`]({{ site.baseurl }}{% link _posts/2026-07-13-xpath-cheatsheet-for-test-automation.md %}#11-advanced-complex-patterns-svg-shadow-dom-modern-css) (reverse parent) |
| **Migration snapshot — step 3 dual-locator** | [§4⚠️ XPath 1.0 discipline]({{ site.baseurl }}{% link _posts/2026-07-13-xpath-cheatsheet-for-test-automation.md %}#4-10-functions-youll-actually-use) (`translate()` over `lower-case()`); [§10.1 POM placement]({{ site.baseurl }}{% link _posts/2026-07-13-xpath-cheatsheet-for-test-automation.md %}#10-sdet-playbook-pom-waits-ci-observability); [§10.6 Browser matrix sanity]({{ site.baseurl }}{% link _posts/2026-07-13-xpath-cheatsheet-for-test-automation.md %}#10-sdet-playbook-pom-waits-ci-observability) |
| **Scenario 4 — Admin settings panel** (`D5 + E5 + F4 + B7`) | [§11.4 Modern CSS `:has()`/`:is()`/`:where()`]({{ site.baseurl }}{% link _posts/2026-07-13-xpath-cheatsheet-for-test-automation.md %}#11-advanced-complex-patterns-svg-shadow-dom-modern-css) (`:is()` OR-grouping) · [§11.7 Sibling combinators]({{ site.baseurl }}{% link _posts/2026-07-13-xpath-cheatsheet-for-test-automation.md %}#11-advanced-complex-patterns-svg-shadow-dom-modern-css) (`~` general-sibling) · [§11.9 Common complex-target patterns]({{ site.baseurl }}{% link _posts/2026-07-13-xpath-cheatsheet-for-test-automation.md %}#11-advanced-complex-patterns-svg-shadow-dom-modern-css) (ARIA chains) · [§11.1 Complex XPath / count-based nth]({{ site.baseurl }}{% link _posts/2026-07-13-xpath-cheatsheet-for-test-automation.md %}#11-advanced-complex-patterns-svg-shadow-dom-modern-css) (B7 ≥ N children) |
...
> **Bottom line of these four scenarios:** CSS + Playwright engine selectors cover ~80% of the rows in tables A–F; the X1–X7 catalog documents the remaining ~20%. Together, **Scenarios 1–4 exercise 12 of the 41 rows** in tables A–F (A2, A4, B3, B7, C1, C2, D5, D8, E1, E5, F1, F4) — the unbacked rows (A1, A3, A5; B1, B2, B4–B6, B8; C3–C5; D1–D4, D6, D7, D9; E2–E4, E6, E7; F2, F3, F5–F7) are the natural backlog for **Scenarios 5+**. §12 of the [article]({{ site.baseurl }}{% link _posts/2026-07-12-xpath-for-test-automation.md %}) + §11 of the [cheatsheet]({{ site.baseurl }}{% link _posts/2026-07-13-xpath-cheatsheet-for-test-automation.md %}) carry the full syntax tree. Use this section as your *worked-example audit surface*: when a new locator shows up in code review, drop it alongside table rows + scenarios and ask "which row does this match?" — and which scenario-like fixture proves it survives?
...
- **For the broader XPath reference** (every pattern in this card is documented there): [XPath Cheatsheet §1–§11 (Jul 2026)]({{ site.baseurl }}{% link _posts/2026-07-13-xpath-cheatsheet-for-test-automation.md %}).
- **For the mental-model + narrative explanation** of why XPath/CSS/engine selectors separate the way they do: [XPath for Test Automation (Jul 2026)]({{ site.baseurl }}{% link _posts/2026-07-12-xpath-for-test-automation.md %}) — §3 axes, §5 functions, §12.5 `:has()`/`:is()`, §12.8 decision flowchart.
- **For boundary-crossing patterns** (X1–X3 above): §12.4 of the article + §11.3 of the cheatsheet.
- **For the broader migration thesis** (BiDi replacing WebDriver): [Selenium BiDi vs Playwright CDP (Jul 2026)]({{ site.baseurl }}{% link _posts/2026-07-16-selenium-bidi-vs-playwright-cdp.md %}).
...
*See also:* [XPath Cheatsheet for Test Automation Engineers (Jul 2026)]({{ site.baseurl }}{% link _posts/2026-07-13-xpath-cheatsheet-for-test-automation.md %}) · [XPath for Test Automation (Jul 2026)]({{ site.baseurl }}{% link _posts/2026-07-12-xpath-for-test-automation.md %}) — the cards this appendix sits beside.
